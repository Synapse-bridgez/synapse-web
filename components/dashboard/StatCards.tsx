...
interface StatCardsProps { txs: Transaction[] }
...
export function StatCards({ txs }: StatCardsProps) {
  ...
  const cards = [
    ...
    { label: "PENDING",    value: counts.PENDING,    sub: "awaiting pickup",   color: STATUS_META.PENDING.color },
    { label: "COMPLETED",  value: counts.COMPLETED,  sub: "settled on-chain",  color: STATUS_META.COMPLETED.color },
    { label: "FAILED",     value: counts.FAILED,     sub: "terminal errors",   color: STATUS_META.FAILED.color },
  ];
